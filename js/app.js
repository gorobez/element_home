(() => {
    ...
    function initSliders() {
        if (document.querySelector(".popular-page__slider")) new core(".popular-page__slider", {
            ...
            navigation: {
                prevEl: ".controls-popular__button-prev",
                nextEl: ".controls-popular__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".production")) {
            let thumbsSwiper = new core(".preview-process__slider", {
            ...
            new core(".images-process__slider", {
        ...
        if (document.querySelector(".card-article")) {
        ...
        if (document.querySelector(".products__slider")) new core(".products__slider", {
            ...
            navigation: {
                prevEl: ".controls-products__button-prev",
                nextEl: ".controls-products__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
    ...
    const slider = document.querySelector(".page-reviews__slider");
    let mySwiper;
    function mobileSlider() {
        if (window.innerWidth <= 767.98 && "false" == slider.dataset.mobile && slider) {
        ...
        if (window.innerWidth > 767.98 && slider) {
